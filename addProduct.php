                    ...
                    if ($title = filter_input(INPUT_POST, "title", FILTER_SANITIZE_FULL_SPECIAL_CHARS)) {
                        if ($description = filter_input(INPUT_POST, "description", FILTER_SANITIZE_FULL_SPECIAL_CHARS)) {
                            if ($category = filter_input(INPUT_POST, "category", FILTER_SANITIZE_FULL_SPECIAL_CHARS)) {
                                if ($category == "Phones" || $category == "Computers" || $category == "Components" || $category == "Smart Watches" || $category == "SmartHome") {
                                } elseif ($category == "phones" || $category == "computers" || $category == "components" || $category == "smart watches" || $category == "smart home") {
                                                    ...
                                                    if (file_exists("images/" . $_FILES['uploaded_file']['name'])){ 
                                                        ...
                                                        INTO product (
                                                            ...
                                                            VALUES (
                                                                ...
                                                                mysqli_stmt_bind_param($stmt, 'isssds', $product_id, $title, $description, $category, $price, $_FILES['uploaded_file']['name']);
                                    ...
                                    echo "<div class='alert-danger bold pt-1 pb-1 pl-1'>Please fill in a valid category.3</div>";
                                }   
                            } else {
        ...
        <div class="w60">
            ...
            <form enctype="multipart/form-data" method="post">
                ...
                <select name="category" class="inputproduct mb-2">
                    ...
                    <option class="inputproduct mt-2 mb-2">Smart Watches</option>
                    <option class="inputproduct mt-2 mb-2">Smart Home</option>
                </select>
                <p class="pt-2">Price<br></p>
                <input class="inputproduct" type="text" name="price">
